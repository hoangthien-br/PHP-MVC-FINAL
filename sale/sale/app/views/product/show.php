        ...
        <div class="card-body">
            <?php if ($product): ?>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h3 class="card-title text-dark fw-bold"><?php echo htmlspecialchars($product->name, ENT_QUOTES, 'UTF-8'); ?></h3>
                        <p class="text-danger fw-bold h4"> 💸 <?php echo number_format($product->price, 0, ',', '.'); ?> VNĐ</p>
                        ...
                        <div class="mt-4">
                            <a href="/Product/addToCart/<?php echo $product->id; ?>" class="btn btn-success px-4"><i class="fas fa-cart-plus me-1"></i> Thêm vào giỏ hàng</a>
                            <a href="/Product" class="btn btn-secondary px-4 ms-2">Quay lại danh sách</a>
                        </div>
                    </div>
                </div>
            <?php else: ?>
